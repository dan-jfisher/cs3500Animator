...
public class DrawableTextShape extends AbstractDrawableShape implements IDrawableShape {
  ...
  /**
   * Constructs drawable text shape. This shape contains all shape's cs3500.animator.model.animation
   * information.
   * @param name name of shape.
   * @param startTime time, in seconds, when shape's cs3500.animator.model.animation starts.
   * @param endTime time, in seconds, when shape's cs3500.animator.model.animation ends.
   ...
   * @param changes changes the shape undergoes in cs3500.animator.model.animation.
   */
  public DrawableTextShape(String name, float startTime, float endTime, ShapeType shapeType,
    ...
    if (shapeColor == null || startTime < 0 || endTime < 0 || name == null
            || xDim < 0 || yDim < 0) {
